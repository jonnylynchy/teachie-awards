...
import com.flux.teachieawards.security.JwtAuthenticationEntryPoint;
import com.flux.teachieawards.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers("/api/user/checkUsernameAvailability", "/api/user/checkEmailAvailability", "/api/user/educators", "/api/user/votesByUser/**", "/api/user/votesByEducator/**")
                .permitAll()
